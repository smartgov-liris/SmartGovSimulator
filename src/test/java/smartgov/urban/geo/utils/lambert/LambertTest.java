...
public class LambertTest {
	...
	public void testN() {
		...
		assertThat(
				Math.floor(Lambert.N(phi, a, e) * 1E4) / 1E4,
	...
	public void testL() {
		...
		assertThat(
				Math.round(Lambert.L(phi1, e) * 1E11) / 1E11,
		...
		assertThat(
				Math.round(Lambert.L(phi2, e) * 1E11) / 1E11,
		...
		assertThat(
				Math.round(Lambert.L(phi3, e) * 1E12) / 1E12,
	...
	public void testC() {
		...
		assertThat(
				Math.round(Lambert.C(k0_1, phi0_1, a_1, e_1) * 1E4) / 1E4,
		...
		assertThat(
				Math.round(Lambert.C(k0_2, phi0_2, a_2, e_2) * 1E4) / 1E4,
	...
	public void testYs() {
		...
		assertThat(
				Math.round(Lambert.Ys(Y0_1, k0_1, phi0_1, a_1, e_1) * 1E4) / 1E4,
		...
		assertThat(
				Math.round(Lambert.Ys(Y0_2, k0_2, phi0_2, a_2, e_2) * 1E4) / 1E4,
	...
	public void testPhi() {
		...
		assertThat(
				Math.round(Lambert.phi(L1, e) * 1E11) / 1E11,
				equalTo(0.872664626)
				);
		...
		assertThat(
				Math.round(Lambert.phi(L2, e) * 1E11) / 1E11,
		...
		assertThat(
				Math.round(Lambert.phi(L3, e) * 1E11) / 1E11,
	...
	public void testLat() {
		...
		Coordinate coord = Lambert.LatLon(n, e, c, lambdaC, Xs, Ys, x, y);
