...
public class GeoNodeSerializationTest {
	...
	public void serializeGeoNode() throws JsonProcessingException {
		GeoNode<GeoArc<?>> node = new GeoNode<>("1", new Coordinate(1.87, 10.12));
		GeoNode<GeoArc<?>> fakeNode = new GeoNode<>("2", new Coordinate(0.8, 1));
		GeoArc<GeoNode<?>> arc1 = new GeoArc<>("1", node, fakeNode);
		GeoArc<GeoNode<?>> arc2 = new GeoArc<>("2", node, fakeNode);
		GeoArc<GeoNode<?>> arc3 = new GeoArc<>("3", fakeNode, node);
