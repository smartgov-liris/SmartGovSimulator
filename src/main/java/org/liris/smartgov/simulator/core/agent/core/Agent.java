 ...
 * defined behavior.
 *
 * The {@link org.liris.smartgov.simulator.core.agent.core.AgentBody AgentBody} of the agent represents
...
public abstract class Agent<A extends AgentAction> {
	 ...
	 * Agent constructor.
	 *
	 * @param id id that can be used to retrieve agents in the {@link org.liris.smartgov.simulator.core.environment.SmartGovContext SmartGovContext}
	 ...
	 *
	 * <ol>
	 * 	<li> Call the Behavior {@link org.liris.smartgov.simulator.core.agent.core.behavior.Behavior#provideAction provideAction()} method </li>
	 * 	<li> Make the AgentBody perform this action with the {@link org.liris.smartgov.simulator.core.agent.core.AgentBody#doAction doAction()} method </li>
	 * </ol>
	 */
	public void live() {
